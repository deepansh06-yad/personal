...
namespace MecPark
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //services.AddControllers();
            services.AddDbContext<MecParkDbContext>(dbContextOption => dbContextOption.UseSqlServer(Configuration.GetConnectionString("Meckparkdb"), b => b.MigrationsAssembly("Entities")));
            
            
            //services.AddAutoMapper(typeof(Startup));
            Business.IOCConfig.ConfigureServices(ref services);
